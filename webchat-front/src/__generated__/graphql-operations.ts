...
export type GetMeQuery = {
  __typename?: 'Query'
  getMe: { __typename?: 'AuthUser'; id: string; email: string; pseudo: string }
}
...
export type LoginMutation = {
  ...
  login: {
    __typename?: 'LoginResponse'
    token: string
    user: { __typename?: 'AuthUser'; id: string; email: string; pseudo: string }
  }
}
...
export type GetRoomMessagesQuery = {
  ...
  getRoomMessages: Array<{
    ...
    content: string
    createdAt: any
    user: { __typename?: 'UserMessage'; id: string; pseudo: string }
  }>
}
...
export type UserJoinedRoomSubscription = {
  __typename?: 'Subscription'
  userJoinedRoom: {
    __typename?: 'ChatMessage'
    id: string
...
export type AddFriendMutation = {
  __typename?: 'Mutation'
  addFriend: { __typename?: 'FriendResponse'; id: string; pseudo: string; isOnline: boolean }
}

export type UserFriendSubscriptionVariables = Exact<{ [key: string]: never }>

export type UserFriendSubscription = {
  __typename?: 'Subscription'
  userFriend: { __typename?: 'FriendResponse'; id: string; pseudo: string; isOnline: boolean }
}
...
export const GetRoomMessagesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetRoomMessages' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'friendId' } },
          type: {
            kind: 'NonNullType',
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'friendId' } }
              }
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<GetRoomMessagesQuery, GetRoomMessagesQueryVariables>
...
export const UserJoinedRoomDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'subscription',
      name: { kind: 'Name', value: 'userJoinedRoom' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'friendId' } },
...
} as unknown as DocumentNode<UserJoinedRoomSubscription, UserJoinedRoomSubscriptionVariables>
export const GetMyFriendsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetMyFriends' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<GetMyFriendsQuery, GetMyFriendsQueryVariables>
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'pseudo' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } }
          }
...
export const UserFriendDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'subscription',
      name: { kind: 'Name', value: 'userFriend' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<UserFriendSubscription, UserFriendSubscriptionVariables>
